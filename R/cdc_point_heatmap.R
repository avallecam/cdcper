...
#'@export cdc_geo_heatmap
#'@export cdc_geo_heatmap_point
#'@export cdc_geo_heatmap_point_mark
#'
...
#' @describeIn cdc_heatmap new name
#' @inheritParams cdc_heatmap
cdc_geo_heatmap <- function(data_shape,data_point,
                        rute_name=NA,subset_list,
                        mp_xlim,mp_ylim,mp_dist,mp_loca) {
...
#' @describeIn cdc_heatmap marked heat map
#' @inheritParams cdc_heatmap
cdc_geo_heatmap_point <- function(data_shape,data_point,rute_name=NA,
                              subset_list,
                              mp_xlim,mp_ylim,mp_dist,mp_loca) {
...
#' @describeIn cdc_heatmap marked heat map
#' @inheritParams cdc_heatmap
cdc_geo_heatmap_point_mark <- function(data_shape,data_point,
                                mp_xlim,mp_ylim,mp_dist,mp_loca) {
